...
| F-08 | No password policy / no MFA | Medium | A07 | **Partially remediated** | TOTP MFA, fail-closed assurance checks, local password rules, masked MFA-gated reset, backup-authenticator support, provider leaked-password rejection, and an interim deny-by-default lost-factor response are implemented and tested/approved. Factor-specific recovery and a robust paid/public-launch recovery method remain |
