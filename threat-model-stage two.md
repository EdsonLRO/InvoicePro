...
| F-08 | No password policy / no MFA | Medium | A07 | **Partially remediated** | TOTP MFA, fail-closed assurance checks, local password rules, masked MFA-gated reset, and backup-authenticator support are implemented. Browser acceptance, leaked-password protection, and an all-factors-lost support process remain |
