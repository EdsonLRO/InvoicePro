...
- Complete controlled desktop/mobile acceptance and deployed audit readback for the account-holder export. Then complete the separate blocked legal/privacy actions in `LEGAL_PRIVACY_READINESS.md`: restricted case tooling, public notices, retention/role decisions, correction/deletion/provider-assistance operations, vendor evidence, and external review.
