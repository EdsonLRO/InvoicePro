...
- The controlled redesign is public as build `2026.09.19.1` from Cloudflare deployment `c7df1127-6a13-4ee7-a9e3-39b6e318b66c` and merge `00191f7`. Approved follow-up build `2026.09.19.2` changes only the mobile invoice-editor flow to Notes, Summary, save, Payments and Activity History. It retains the Owner Console, canonical recovery-link correction, complimentary access, account-data export, branded notices and first-sign-in subscription guidance. The Supabase Auth Site URL remains `https://app.tallyo.co.uk/`; no backend, Auth, provider or website change belongs to this frontend follow-up.
