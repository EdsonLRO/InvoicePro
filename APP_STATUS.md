...
- The controlled redesign is public as build `2026.09.19.3` from Cloudflare deployment `9690dc1c-2ab5-42ae-a88f-bbb79cab46a7` and merge `06d718d`. The Owner approved focused follow-up build `2026.09.19.4`: customer and Products & services records use separate rounded cards with consistent expanded/compact white and light-slate surfaces and complete contours. It retains the Owner Console, canonical recovery-link correction, complimentary access, account-data export, branded notices and first-sign-in subscription guidance. The Supabase Auth Site URL remains `https://app.tallyo.co.uk/`; no backend, Auth, provider or website change belongs to this frontend follow-up.
