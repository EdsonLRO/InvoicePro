...
| TOTP MFA | In Progress | Primary/backup enrolment and sign-in, wrong-code sign-in and recovery rejection, protected backup removal, one-factor preservation, restoration to two verified factors, and one enrolled-factor-gated masked password-recovery path passed on 2026-07-14. Complete factor-specific recovery, email-only bypass rejection, lookup-error simulation, audit-content checks, and the all-factors-lost support process. |
