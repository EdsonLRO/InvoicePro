...
| Backups and restore | Verified | A selected daily backup restored to an isolated project on 2026-07-15. Exact data/structure counts matched, copied automation was disabled, and restored tenant isolation passed. Evidence: `BACKUP_RESTORE_TEST_EVIDENCE_2026-07-15.md`. Temporary-project deletion remains approval-gated cleanup. |
