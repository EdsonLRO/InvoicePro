...
Tallyo's current invoicing-app scope is feature-complete and regression-verified, and its controlled live Stripe invoice-payment path is activated and acceptance-tested. Build `2026.07.22.2` is published from merge commit `17b8ee7` after exact Owner approval of the PR #76–#83 stack, required security run `29922330142`, post-merge security run `29922434061`, Pages run `29922431260`, and HTTPS build/service-worker/brand-asset readback. The separate public website was not launched. The app is not approved for unrestricted live-customer onboarding because the separate legal, privacy and operational gates remain open.

## Release Gates

| Gate | Status | Evidence / next action |
|---|---|---|
| Core invoicing workflows | Verified | The final 2026-07-16 regression remains current. `FUNC-READY-002` additionally completed a clean fictional customer/item, invoice, quote conversion, duplicate, status, standalone credit, PDF/XLSX and recurring create/pause/resume/edit journey without sending email, entering Checkout, moving money or deleting data. Public build `2026.07.22.2` retains that validated baseline and adds Help/install integration and the shared Tallyo brand identity without changing functional/Auth/payment source; focused checks, required/post-merge security, Pages and HTTPS readback pass. |
