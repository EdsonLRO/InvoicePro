...
| PDF regression | In Progress | Deployed desktop acceptance is verified: an authenticated synthetic 24-row invoice produced a clean three-page A4 PDF, and JPEG/image-alias hardening reduced it from 35,767,558 to 689,481 bytes (about 98.1%). Only the authenticated phone download remains. |
