...
| All-factors-lost account recovery | In Progress | Backend deployment and all retained AUTH-002 acceptance gates are complete: boundary, privilege, AAL, rolled-back RLS, authenticated generation/replacement/recovery, audit-minimisation, two-account, rollback-only live-throttling, Owner-confirmed notification minimisation, and real-Android recovery/re-enrolment pass. The mobile dialog clipping correction passed focused and phone retesting. Final internal legal review permits Owner-approved controlled test/portfolio publication; PR #44 remains draft and the frontend remains unpublished. External UK legal/privacy review is still required before paid/public onboarding. |
