...
| Audit events | In Progress | Provider and selected app actions covered; failed-email evidence is minimised, and overdue-reminder provider/history failures now produce privacy-safe events. This is not a full SIEM or compliance system. |
