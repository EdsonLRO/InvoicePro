...
| All-factors-lost account recovery | In Progress | Backend deployment is complete: migrations through `20260716161054`, server-only pepper, and JWT-protected `mfa-recovery` version 1 are live. Boundary, privilege, AAL, and rolled-back RLS probes pass. Authenticated generation/replacement/throttling/recovery, notices and audit review, two-account isolation, browser/device acceptance, and Legal Agent condition closure remain before frontend publication or paid/public onboarding. |
