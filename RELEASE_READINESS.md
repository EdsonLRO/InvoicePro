...
| TOTP MFA | In Progress | Primary/backup enrolment and sign-in, wrong-code rejection, protected backup removal, one-factor preservation, restoration to two verified factors, and one enrolled-factor-gated masked password-recovery path passed on 2026-07-14. Complete negative and factor-specific recovery tests, lookup-error simulation, audit-content checks, and the all-factors-lost support process. |
