...
The D07 provider shortlist is recorded in `RESTRICTED_CASE_SYSTEM_OPTIONS_2026-07-17.md`. On 2026-07-17, the Owner reported that the existing Gmail service uses Tallyo's business domain, so the Google Workspace route is the preferred candidate. The exact edition and Vault entitlement remain unconfirmed; `GOOGLE_WORKSPACE_PRIVACY_CASE_PLAN_2026-07-17.md` records the blocked configuration and synthetic-acceptance plan. No provider, account, trial, contract, purchase, configuration, or live-data use has been approved.
