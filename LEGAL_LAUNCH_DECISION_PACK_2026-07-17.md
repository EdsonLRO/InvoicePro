...
| D03 | Eligible customers and contracting model | Start with UK-based business customers aged 18 or over; exclude consumer use, minors, regulated/special-category workflows, and non-UK onboarding until separately reviewed. | Owner product decision; consumer/B2B legal review | Blocks Terms and onboarding design |
