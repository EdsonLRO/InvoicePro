...
- **MFA has no provider recovery codes.** Tallyo supports a second authenticator and blocks email-only MFA recovery. The interim all-factors-lost response is approved and deny-by-default; factor-specific browser acceptance remains, and robust recovery is still required before paid/public onboarding.
