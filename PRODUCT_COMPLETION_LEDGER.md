...
| AUTO-001 | Authenticate privileged scheduled automation calls | High | Implemented | Security Agent | Sol / Terra | Migration/function deployed; scheduled acceptance remains unlocked | `generate-recurring` v12 rejects unsigned calls and both cron jobs now use the Vault-backed automation secret. Confirm the next 06:00/09:00 UTC runs before marking Verified. |
