...
| Append-only audit events | In Progress | Provider events and selected app actions covered. Failed-email audits were minimised on 2026-07-14, and deployed overdue-reminder v8 records privacy-safe provider/history failure stages without recipient, message, customer, or raw-response data. Privacy-safe restore evidence is recorded separately. |
