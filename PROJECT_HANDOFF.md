...
- **MFA has no provider recovery codes.** Tallyo supports a second authenticator and blocks email-only MFA recovery. The Owner approved an interim deny-by-default all-factors-lost response on 2026-07-14; factor-specific recovery acceptance remains, and robust recovery is still required before paid/public onboarding. Supabase leaked-password protection was enabled and advisor-verified on 2026-07-13, and its safe rejection path passed on 2026-07-14.
