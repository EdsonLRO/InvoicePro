...
- **MFA has no provider recovery codes.** Tallyo supports a second authenticator and blocks email-only MFA recovery, but factor-specific recovery acceptance and an all-factors-lost support procedure remain. Supabase leaked-password protection was enabled and advisor-verified on 2026-07-13, and its safe rejection path passed on 2026-07-14.
