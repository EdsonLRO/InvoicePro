...
|---|---|---|---|---|
| Supabase | Auth, database, Edge Functions, backups, scheduler/Vault | Account and workspace data | June 2026 DPA, London region, UK Addendum/SCC route, subprocessors, deletion and incident terms recorded in `VENDOR_TRANSFER_EVIDENCE_2026-07-17.md`; account incorporation and transfer-risk decision remain open | Evidence collected; legal acceptance pending |
| Resend | Transactional invoice/reminder/security email and delivery events | Recipient, message/PDF, delivery metadata | DPA, UK transfer route, 15 July 2026 subprocessor list, termination deletion statement, dashboard/export/share behaviour recorded; processing scope, retention and transfer decision remain open | Evidence collected; legal acceptance pending |
