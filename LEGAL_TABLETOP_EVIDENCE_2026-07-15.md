...
- Account/workspace export and deletion are not verified as an operational workflow.
...
| Build and verify export, correction and deletion operations | High | Planned | Blocks public onboarding |
