...
(async () => {
  ...
  assert.deepEqual(cacheNames, ['tallyo-shell-2026-07-18-6']);
  ...
  assert.match(indexSource, /const APP_BUILD = '2026\.07\.18\.6';/, 'frontend build marker must match the worker release');
