...
(async () => {
  ...
  assert.deepEqual(cacheNames, ['tallyo-shell-2026-07-16-2']);
  ...
  assert.match(indexSource, /const APP_BUILD = '2026\.07\.16\.2';/, 'frontend build marker must match the worker release');
