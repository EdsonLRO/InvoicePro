...
(async () => {
  ...
  assert.deepEqual(cacheNames, ['tallyo-shell-2026-07-18-4']);
  ...
  assert.match(indexSource, /const APP_BUILD = '2026\.07\.18\.4';/, 'frontend build marker must match the worker release');
