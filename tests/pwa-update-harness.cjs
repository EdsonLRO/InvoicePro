...
(async () => {
  ...
  assert.deepEqual(cacheNames, ['tallyo-shell-2026-09-19-4']);
  ...
  assert.match(indexSource, /const APP_BUILD = '2026\.09\.19\.4';/, 'frontend build marker must match the worker release');
