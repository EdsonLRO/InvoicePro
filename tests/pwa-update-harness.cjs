...
(async () => {
  ...
  assert.deepEqual(cacheNames, ['tallyo-shell-2026-09-20-3']);
  ...
  assert.match(indexSource, /const APP_BUILD = '2026\.09\.20\.3';/, 'frontend build marker must match the worker release');
