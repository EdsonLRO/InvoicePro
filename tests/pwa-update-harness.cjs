...
(async () => {
  ...
  assert.deepEqual(cacheNames, ['tallyo-shell-2026-09-24-1']);
  ...
  assert.match(indexSource, /const APP_BUILD = '2026\.09\.24\.1';/, 'frontend build marker must match the worker release');
