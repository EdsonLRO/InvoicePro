...
assert.match(app, /window\.TALLYO_BILLING_TEST_ENABLED === true && window\.STRIPE_LIVE_MODE !== true/, 'Billing UI must require its explicit test gate and refuse live mode');
