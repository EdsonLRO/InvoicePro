...
- **Status:** Implemented; factor-management, one successful password-recovery path, wrong-code recovery rejection, email-only bypass rejection, and the interim all-factors-lost process are accepted; factor-specific recovery tests pending.
