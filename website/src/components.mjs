...
const demoContents = Object.freeze({
  ...
  payments: `<div class="demo-balance"><span>Balance</span><strong>£0.00</strong><em>Paid</em></div><div class="demo-list"><p><b>£200.00</b><span>Bank transfer recorded</span><em class="is-paid">Recorded</em></p><p><b>£40.00</b><span>Cash payment recorded</span><em class="is-paid">Recorded</em></p></div>`,
  activity: `<div class="demo-timeline"><p><i></i><span><strong>Invoice emailed</strong><small>Delivered · 09:42</small></span></p><p><i></i><span><strong>Payment recorded</strong><small>£240.00 · 10:18</small></span></p><p><i></i><span><strong>Invoice marked paid</strong><small>10:18</small></span></p></div>`,
...
export const productDemo = (scene, index) => `
  <figure class="product-demo product-demo-${escapeHtml(scene.variant)}${index % 2 ? " product-demo-reverse" : ""}" id="${escapeHtml(scene.id)}">
    ...
    ${scene.image
      ? `<div class="demo-window demo-window-capture"><img class="demo-window-screenshot" src="${escapeHtml(scene.image)}?v=__TALLYO_ASSET_REVISION__" alt="${escapeHtml(scene.imageAlt)}" loading="lazy" decoding="async"></div>`
      : `<div class="demo-window" role="img" aria-label="Fictional-data illustration of Tallyo ${escapeHtml(scene.label.toLowerCase())}"><div class="demo-window-bar"><i></i><i></i><i></i><strong>Tallyo</strong><span>Fictional demonstration</span></div><div class="demo-window-body">${demoContents[scene.variant]}</div></div>`}
