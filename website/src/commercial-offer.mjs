...
export const connectPaymentCopy = Object.freeze({
  disabled: Object.freeze({
    ...
    faq: "Not yet. Tallyo is preparing this so each participating business can connect its own Stripe account and receive customer card payments directly.",
...
export const commercialOffer = Object.freeze({
  ...
  pro: Object.freeze({
    ...
    features: Object.freeze([
      ...
      "Amounts paid, still due and overdue",
      "Regular invoices created on your schedule",
      "Optional automatic email for each new invoice",
      "Reminders for the overdue invoices you choose",
      "History of sends, reminders and payments",
