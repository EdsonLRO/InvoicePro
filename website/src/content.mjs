...
export const productScenes = Object.freeze([
  ...
  { id: "quote", label: "Quotes", title: "Let the customer accept online", caption: "Send a secure response link. Acceptance records the confirmed customer name and time, then creates one linked invoice automatically.", variant: "quote", image: "/assets/product/tallyo-quote-editor.jpg", imageAlt: "Tallyo quote editor filled with fictional Willow and Pine Studio quote details" },
  { id: "customers", label: "Customers and products & services", title: "Reuse the details you need", caption: "Keep repeat customers and commonly used products or services ready for the next document.", variant: "customers", image: "/assets/product/tallyo-customers.jpg", imageAlt: "Tallyo customer list filtered to the fictional Willow and Pine Studio customer" },
