...
export const productScenes = Object.freeze([
  ...
  { id: "customers", label: "Customers and saved items", title: "Reuse the details you need", caption: "Keep repeat customers and commonly used products or services ready for the next document.", variant: "customers", image: "/assets/product/tallyo-customers.png", imageAlt: "Tallyo customer list filtered to the fictional Willow and Pine Studio customer" },
  ...
  { id: "overdue", label: "Overdue work", title: "Follow up by choice", caption: "Review overdue balances and enable reminders only for the invoices you want Tallyo to follow up.", variant: "overdue", image: "/assets/product/tallyo-overdue.png", imageAlt: "Tallyo invoices page showing a fictional overdue Willow and Pine Studio invoice" },
  { id: "payments", label: "Payments", title: "Keep payment status with the invoice", caption: "See recorded payments and the remaining balance together with the relevant invoice.", variant: "payments", image: "/assets/product/tallyo-payments.png", imageAlt: "Tallyo payment history showing a fictional one pound card payment and refund" },
  { id: "activity", label: "Activity history", title: "Understand what happened", caption: "Document, email, payment and refund activity stays attached to the relevant record.", variant: "activity", image: "/assets/product/tallyo-activity.png", imageAlt: "Tallyo activity history showing fictional document payment and refund events" },
  { id: "branding", label: "Branding", title: "Make documents recognisably yours", caption: "Add business details, a logo and document styling that carry through to customer PDFs.", variant: "branding", image: "/assets/product/tallyo-branding.png", imageAlt: "Tallyo branding controls and fictional invoice preview" },
  { id: "security", label: "Account security", title: "Choose stronger sign-in protection", caption: "Manage authenticator-app MFA, recovery codes and sign-out controls from Account Security.", variant: "security", image: "/assets/product/tallyo-security.png", imageAlt: "Tallyo two-factor authentication settings without private account information" },
