import { faqs, featureGroups, industries, installationSteps, plans, productFacts } from "./content.mjs";
...
const home = `
  ...
  <section class="section section-soft" aria-labelledby="how-title">
    ...
    <ol class="steps">
      <li><span>1</span><div><h3>Set up your business</h3><p>Add the details and branding you want on your documents.</p></div></li>
      <li><span>2</span><div><h3>Add a customer</h3><p>Save the people and businesses you invoice regularly.</p></div></li>
      <li><span>3</span><div><h3>Create a quote or invoice</h3><p>Add services, prices, dates and payment details.</p></div></li>
      <li><span>4</span><div><h3>Send and track</h3><p>Email, download or share a card-payment link, then follow the status.</p></div></li>
    </ol>
  </section>
  ...
  <section class="section" aria-labelledby="feature-preview-title">
    ...
    <p class="section-link"><a href="/features/">See all Tallyo features <span aria-hidden="true">→</span></a></p>
  </section>
...
const help = `
  <section class="page-hero"><p class="eyebrow">Help Centre</p><h1>Clear guidance for the work you want to finish.</h1><p>Start with the most common Tallyo tasks. More detailed guides will be added from the same reviewed product knowledge.</p></section>
  <section class="section"><div class="help-grid"><a href="/features/"><span>01</span><h2>Create documents</h2><p>Understand invoices, quotes, credit notes and the route from quote to payment.</p></a><a href="/security/"><span>02</span><h2>Protect your account</h2><p>Learn about confirmed accounts, optional MFA, recovery and sign-out controls.</p></a><a href="/faq/"><span>03</span><h2>Common questions</h2><p>Find direct answers about payments, reminders, installation and internet access.</p></a><a href="/free-invoice-generator/"><span>04</span><h2>Make a free invoice</h2><p>Use the public invoice maker when it becomes available in the next website milestone.</p></a></div></section>
  <section class="section section-soft" id="install" aria-labelledby="install-help-title"><div class="section-heading"><p class="eyebrow">Install Tallyo</p><h2 id="install-help-title">Keep Tallyo close on supported devices.</h2><p>Installation adds a convenient app icon. It does not make authenticated business records available offline.</p></div><div class="install-grid">${installationSteps.map(([name, step]) => `<article><h3>${name}</h3><p>${step}</p></article>`).join("")}</div></section>
  ${finalCta()}`;
...
export const pages = Object.freeze([
  ...
  { route: "/help/", output: "help/index.html", title: "Tallyo Help Centre", description: "Find clear guidance for Tallyo documents, payments, account protection, installation and common questions.", content: help, schema: "webpage" },
  { route: "/faq/", output: "faq/index.html", title: "Tallyo frequently asked questions", description: "Answers about Tallyo invoices, quotes, recurring work, card payments, security, installation and internet access.", content: faq, schema: "faq" },
