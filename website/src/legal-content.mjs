...
export const privacyNotice = `
  ...
  <article class="legal-document">
    ...
    <section>
      ...
      <h3>AI Helper</h3>
      <p>The public AI Helper answers questions about public Tallyo product information. To understand follow-up questions, Tallyo sends the visitor's current message, up to three recent exchanges from the same open page and selected reviewed public Tallyo information to OpenAI. The Helper is not designed to access account records or private business/customer data, and visitors must not enter that information.</p>
