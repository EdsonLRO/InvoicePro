...
const providerRequest = (question, history, publicKnowledge) => {
  ...
  instructions: [
    ...
    "When recent conversation makes a short message such as 'what comes next?', 'what do you advise?' or 'tell me more' clear, answer in that context. Do not ask the visitor to repeat a topic that is already clear from recent turns.",
